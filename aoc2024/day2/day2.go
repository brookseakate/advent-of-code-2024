...
// TODO: remove – too complicated & cute / didn't work
//func countSafeReportsWithTolerance(reports [][]int, toleranceCount int) int {
//	count := 0
//	originalTolerance := toleranceCount
//
...
// TODO: remove – this one was REALLY a mess...stack overflowed?
//func countSafeReportsWithTolerance(reports [][]int, toleranceCount int) int {
//	count := 0
//	originalTolerance := toleranceCount
//
...
//		if safe, indexFoundUnsafe := isSafe(report); safe {
//			count++
//		} else if countMaybeSaferReversed := countSafeReportsWithTolerance([][]int{reportReversed}, toleranceCount); countMaybeSaferReversed > 0 {
//			count += countMaybeSaferReversed
//		} else {
//			fmt.Printf("found unsafe reportIndex: %v, report values: %v\n", reportIndex, report)
//			if toleranceCount > 0 {
//				toleranceCount--
